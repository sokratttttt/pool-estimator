...
import { TrendingUp, DollarSign, FileText, Target, Calendar, User, Filter } from 'lucide-react';
import { motion } from 'framer-motion';
import AppleButton from '@/components/apple/AppleButton';

export default function AnalyticsPage() {
    const { estimates, loadEstimates } = useHistory();
    ...
    const managers = useMemo(() => getManagers(estimates), [estimates]);
