 ...
 */
export const getAccessibleButtonProps = (label: string, options: any = {}) => {
 ...
 */
export const getAccessibleFieldProps = (id: string, label: string, options: any = {}) => {
    const {
        required = false,
        invalid = false,
        describedBy = null,
 ...
 */
export const isFocusable = (element: any) => {
 ...
 */
export const trapFocus = (container: any) => {
