 ...
 */
export function generateContract(estimate: EstimateData, clientInfo: ClientInfo, options: ContractOptions = {}) {
...
function prepareContractData(estimate: EstimateData, clientInfo: ClientInfo, options: ContractOptions) {
...
function fillContractTemplate(data: Record<string, string>) {
...
function generatePaymentSchedule(totalCost: number, terms?: string) {
    if (terms === 'full') {
...
function calculateTimeline(estimate: EstimateData) {
...
function formatCompanyDetails(_options: ContractOptions) {
...
function formatClientDetails(clientInfo: ClientInfo) {
 ...
 */
export function generateContractAppendix(estimate: EstimateData) {
 ...
 */
export function exportContractHTML(contract: string, appendix: string) {
    return `
<!DOCTYPE html>
<html>
<head>
