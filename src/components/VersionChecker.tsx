...
export default function VersionChecker() {
    ...
    useEffect(() => {
        ...
        if (inElectron && (window as any).electron.getAppVersion) {
    ...
    const handleUpdate = () => {
        if (isElectron && (window as any).electron.downloadUpdate) {
    ...
    const handleInstallUpdate = () => {
        if (isElectron && (window as any).electron.quitAndInstall) {
