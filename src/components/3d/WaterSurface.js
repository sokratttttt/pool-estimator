 ...
 */
export default function WaterSurface({ length = 10, width = 5, shape = 'rectangular' }) {
 ...
 */
function createRectangularWater(length, width) {
 ...
 */
function createOvalWater(length, width) {
    const wallThickness = 0.3;
