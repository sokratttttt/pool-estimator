...
import { generatePoolDescription, generateVariations } from '@/lib/descriptionGenerator';
import { toast } from 'sonner';

export default function DescriptionGeneratorModal({ isOpen, onClose, estimate }) {
                    ...
                    <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
                        {!descriptions ? (
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Готовы создать описание?</h3>
                            ...
                            <>
                                ...
                                <div className="flex gap-2 mb-6 border-b">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-t-lg font-medium transition-colors ${activeTab === tab.key
                                ...
                                <div className="bg-gray-50 rounded-lg p-6 mb-4 relative">
                                    <button
                                        ...
                                        className="absolute top-4 right-4 p-2 bg-white rounded-lg shadow hover:bg-gray-100 transition-colors"
                                        title="Копировать"
                                    >
