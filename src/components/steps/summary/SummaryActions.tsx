...
interface SummaryActionsProps {
    setShowCatalogSelector: React.Dispatch<React.SetStateAction<boolean>>;
    ...
    handleExportContract: () => void;
    handleExportProposal: () => void;
    handleSendWhatsApp: () => void;
    setShowGanttModal: React.Dispatch<React.SetStateAction<boolean>>;
