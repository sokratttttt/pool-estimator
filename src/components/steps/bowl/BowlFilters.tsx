...
interface BowlFiltersProps {
    ...
    onPriceRangeChange: (range: FilterRange) => void;
    lengthRange: FilterRange;
    onLengthRangeChange: (range: FilterRange) => void;
}
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onPriceRangeChange({ ...priceRange, min: e.target.value })}
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onPriceRangeChange({ ...priceRange, max: e.target.value })}
                            className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        />
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onLengthRangeChange({ ...lengthRange, min: e.target.value })}
                            className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        />
                        <span className="text-slate-400">-</span>
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onLengthRangeChange({ ...lengthRange, max: e.target.value })}
                            className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        />
                    </div>
                </div>
