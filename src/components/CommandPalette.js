...
import { Search, Calculator, History, Package, MessageSquare, FileText, Plus, Save, Download, Settings, Home, Palette, ClipboardList, Users } from 'lucide-react';
...
export default function CommandPalette() {
    ...
    }, [open, fetchRequests, fetchClients]);
...
function CommandItem({ icon, children, shortcut, onSelect }) {
    return (
        <Command.Item
            onSelect={onSelect}
