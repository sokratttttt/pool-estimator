...
export function useKeyPress(targetKey: string, handler: (event: KeyboardEvent) => void, options: KeyPressOptions = {}): any {
    useEffect(() => {
 ...
 */
export function useEscapeKey(handler: (event: KeyboardEvent) => void): any {
 ...
 */
export function useEnterKey(handler: (event: KeyboardEvent) => void): any {
